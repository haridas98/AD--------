...
export async function generateGeminiProjectMetadata({
  ...
  const prompt = [
    ...
    'Do not use every supported block type. Keep the page focused: usually 5 to 7 blocks total.',
    'When there are many images, put most of them into imageGrid or refinedSlider instead of creating many different block types.',
    ...
    'Use circleDetail only when there are at least 8 attached images worth inspecting closely.',
