      ...
      <motion.main className="page-shell page-shell--offset contact-page" initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
        ...
        <div className="contact-info">
          ...
          <div className="contact-socials">
            {site?.instagram && (
              <a href={site.instagram} target="_blank" rel="noopener noreferrer" className="contact-social-link">
            ...
            {site?.facebook && (
              <a href={site.facebook} target="_blank" rel="noopener noreferrer" className="contact-social-link">
            ...
            {site?.houzz && (
              <a href={site.houzz} target="_blank" rel="noopener noreferrer" className="contact-social-link">
