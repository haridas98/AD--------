    ...
    <footer className={styles.siteFooter}>
      <div className={styles.inner}>
        ...
        <div className={styles.footerSocial}>
          ...
          {site.houzz && (
            <a href={site.houzz} target="_blank" rel="noopener noreferrer" aria-label="Houzz">
              <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor"><path d="M12 0c-6.627 0-12 5.373-12 12s5.373 12 12 12 12-5.373 12-12-5.373-12-12-12zm-1.955 17.291h-2.045v-7.981h-2.977v-1.775h5.022v9.756zm3.955-17.291h-4v3.273h4v-3.273z" /></svg>
            </a>
          )}
        </div>
      </div>
