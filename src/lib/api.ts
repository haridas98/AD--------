...
export const api = {
  ...
  updateTestimonial: (id: string, payload: any) => request(`/api/admin/testimonials/${id}`, { method: 'PUT', body: JSON.stringify(payload) }),
  deleteTestimonial: (id: string) => request(`/api/admin/testimonials/${id}`, { method: 'DELETE' }),
  ...
  generateProjectImageSeo: (projectId: string, payload: any) => request(`/api/admin/projects/${projectId}/assets/generate-seo`, { method: 'POST', body: JSON.stringify(payload) }),
